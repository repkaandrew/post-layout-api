...
* The original package name 'com.riepka.post-layout-app' is invalid and this project uses 'com.riepka.postlayoutapp' instead.
...
```
$ docker run --rm -p 8080:8080 post-layout-app:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/post-layout-app
```
